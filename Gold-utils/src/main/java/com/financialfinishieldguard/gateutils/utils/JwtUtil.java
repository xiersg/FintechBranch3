...
import com.financialfinishieldguard.gateutils.constants.enumm.ConfigEnum;
import com.financialfinishieldguard.gateutils.constants.enumm.TimeOutEnum;
...
public class JwtUtil {
     ...
     * @return JWT
     */
    public static String generate(String id, String role) {
        // 过期时间
        Date expiryDate = new Date(System.currentTimeMillis() + expiration.toMillis());

        //不知道为什么解析role总是解析不出来，然后id就可以，换一种方法
//        Map<String, Object> claims = new HashMap<>();
//        claims.put(AuthConstant.USER_ID, id);
//        claims.put(AuthConstant.ROLE, role);
//        return Jwts.builder()
...
//                .compact();//将构建好的 JWT 序列化为一个紧凑的字符串。
        ...
        return Jwts.builder()
                ...
                .claim(AuthConstant.USER_ID, id)  // 使用claim而不是setClaims
                .claim(AuthConstant.ROLE, role)
                .compact();
    }
